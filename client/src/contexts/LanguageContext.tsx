...
export const translations: Translations = {
  ...
  "about.description": {
    ...
    PT: "Erica Franzetti é árbitro internacional e advogada de disputas internacionais. Ela agora foca sua prática em servir como árbitro independente em disputas transfronteiriças complexas e em aconselhar clientes sobre estratégia de disputas, execução e proteção de investimentos."
  },
