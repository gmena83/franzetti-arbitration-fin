        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              {/* CV Downloads */}
              <div className="pt-6 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-charcoal mb-4">Download CV</h3>
                <div className="flex flex-wrap gap-3">
                  <a
                    href="#"
                    className="inline-flex items-center px-4 py-2 border border-aquamarine text-aquamarine rounded hover:bg-aquamarine hover:text-white transition-colors text-sm font-medium"
                  >
                    English
                  </a>
                  <a
